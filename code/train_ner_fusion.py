...
def main():
    ...
    parser.add_argument("--pred_output_dir", type=str, default="", help="For distant debugging.")
    ...
    # TOkenizer embedding size print
    logger.info("Tokenizer vocab size: {}".format(len(tokenizer)))

    # Add special tokens if not already added
    special_tokens = ["<PER>", "</PER>", "<LOC>", "</LOC>", "<ORG>", "</ORG>", "<MISC>", "</MISC>"]
    ...
    # check model after resize
    # print model vocab size
    logger.info("model embedding size: {}".format(model.config.vocab_size))
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        if args.pred_output_dir == "":
            ...
            output_dev_results_file = os.path.join(args.pred_output_dir, args.dev_result_file)
        ...
        if args.pred_output_dir == "":
            ...
            output_dev_predictions_file = os.path.join(args.pred_output_dir, args.dev_prediction_file)
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        if args.pred_output_dir == "":
            ...
            output_test_results_file = os.path.join(args.pred_output_dir, args.test_result_file)
        ...
        if args.pred_output_dir == "":
            ...
            output_test_predictions_file = os.path.join(args.pred_output_dir, args.test_prediction_file)
